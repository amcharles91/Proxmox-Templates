...
source "proxmox-iso" "ubuntu-server" {
  ...
  #cloud init settings
  # set cloud init to false with proxmox where after creating template with packer, 
  # terraform with telmate. Switching to bpg does not seem to have the same problem. will try installing a cloud init drive even though 1 is present.
